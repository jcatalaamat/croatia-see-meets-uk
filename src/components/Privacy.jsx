...
Visitors to the website – if you visit our websites or landing pages we, the third party that runs the website on our behalf, and a third-party analytics service, may collect information relating to your visit including, but not limited to, traffic data, location data, weblogs and other communication data, and the resources that you access. The analytics information is only processed in a way which does not identify anyone. We do not make, and do not allow the analytics service provider to make, any attempt to find out the identities of those visiting our website. Please also see our Terms and Conditions and our Cookies Disclaimer for further information about the use of the website.
        <br />
        <br />
Persons booking events with the British Croatian Chamber of Commerce – if you book an event with BCCC then we will hold any personal data that is collected as part of the booking process, such as name, email address, telephone address and other contact details. We will process personal financial data if you make payments from a personal account (rather than a business account). If payment is taken using a personal credit or debit card, then our bank(s), the provider(s) of the card payment device, will also process your data. We may also receive personal data about you or your guests if you provide any in the context of the event. Should you provide us with personal data on individuals other than yourself, you confirm that you have their consent to do so. Correspondence and booking information in respect of your event will be retained for up to two years after your event for accounting purposes and to address any queries that arise following your event. After this time your personal data will be deleted, unless (i) it is required for a legal reason, or (ii) you have requested to receive information about future BCCC events, in which case we will retain your contact information, which will be used only for this purpose.
        <br />
        <br />
If you do join our mailing list and subsequently decide that you would like to be removed, you can unsubscribe by emailing us at events@britishcroatian.co.uk or members@britishcroatiancc.co.uk.
        <br />
        <br />
...
We also process your personal data on the lawful basis of consent where you have opted to receive information about future events at BCCC. You may withdraw this consent at any time by unsubscribing from our mailing list as described above. We do not ever sell or pass personal data to third parties for marketing purposes.
        <br />
        <br />
Finally, we also rely on the lawful basis of consent if you apply for a job at BCCC and agree for us to retain your details for potential future positions.
        <br />
        <br />
...
Finally, in the event that we sell or buy any business or assets, we may disclose personal data to the prospective seller or buyer of such business or assets. If we are acquired by a third party, personal data will be one of the transferred assets.
      ...
      <p>
        <br />
        <b>How information is kept secure</b>
        <br />
        <br />
...
On occasion we include links to third parties on this website. Where we provide a link it does not mean that we endorse or approve that site’s policy towards visitor privacy. You should review their privacy policy before sending them any personal data.
      ...
      <p>
        <b>Transfers of data outside of the EEA</b>
        <br />
        <br />
        <br />
...
Please do not hesitate to contact us regarding any matter relating to this Privacy Policy via email at  events@britishcroatian.co.uk or members@britishcroatiancc.co.uk according to your query.
      </p>
      <p>
        <br />
        <br />
        <br />
        <b>Cookies Disclaimer - Use of Cookies</b>
        <br />
        <br />
...
You can adjust the settings on your computer to decline any cookies if you wish. This can be done within the “settings” section of your computer. For more information please read the advice at AboutCookies.org
        <br />
        <br />
Cookies used in this website: e.g. Google Analytic
